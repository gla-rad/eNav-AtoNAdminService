...
/**
 * The S-201 Light Vessel Entity Class.
 * <p>
 * This is the basic class for implementing the S-201-compatible Light Vessel
 * type. It is modelled as an entity that extends the {@link StructureObject}
 * super class.
 *
 * @author Nikolaos Vastardis (email: Nikolaos.Vastardis@gla-rad.org)
 * @see _int.iho.s_201.gml.cs0._2.LightVessel
 */
@Entity
