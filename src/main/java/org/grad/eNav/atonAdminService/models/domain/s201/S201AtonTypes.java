...
public enum S201AtonTypes {
    ...
    LIGHT_AIR_OBSTRUCTION("Light Air Obstruction", LightAirObstructionImpl.class, LightAirObstruction.class),
    ...
    LANDMARK("Landmark", LandmarkTypeImpl.class, Landmark.class),
