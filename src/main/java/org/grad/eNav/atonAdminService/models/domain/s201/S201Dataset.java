...
/**
 * The S-201 Dataset Entity Class
 * <p>
 * This class is used to map the fixed datasets defined for the S-201 Aids to
...
public class S201Dataset {
    ...
    @JoinTable(name = "s201_dataset_content_xref",
            joinColumns =
     ...
     */
    public S201Dataset() {
        this("auto_generated_s_201_dataset" + LocalDateTime.now().format(DateTimeFormatter.ISO_LOCAL_DATE_TIME));
    }
     ...
     */
    public S201Dataset(String datasetFileIdentifier) {
        this.datasetIdentificationInformation = new S201DatasetIdentification(datasetFileIdentifier);
    }
     ...
     */
    public S201DatasetIdentification getDatasetIdentificationInformation() {
     ...
     */
    public void setDatasetIdentificationInformation(S201DatasetIdentification datasetIdentificationInformation) {
     ...
     */
    @JsonIgnore
    public S201Dataset copy() {
        // Create the copy
        final S201Dataset copy = new S201Dataset();
     ...
     */
    public S201Dataset replace() {
        final S201Dataset copied = this.copy();
